...
from crm.forms import EmployeesForm,EmployesModelForm,RegistrationForm,LoginForm
...
class EmployecreateView(View):
    ...
    def post(self,request,*args,**kwargs):
         form=EmployesModelForm(request.POST,files=request.FILES)
         if form.is_valid():
              form.save()
...
class EmployeeUpdateView(View):
     def get(self,request,*args,**kwargs):
          ...
          form=EmployesModelForm(instance=obj)
          return render(request,"emp_edit.html",{"form":form})
     def post(self,request,*args,**kwargs):
          id=kwargs.get("pk")
          obj=Employees.objects.get(id=id)
          form=EmployesModelForm(request.POST,instance=obj,files=request.FILES)
          if form.is_valid():
            form.save()
